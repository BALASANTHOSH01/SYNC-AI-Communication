    ...
    return (
        <div className=' mt-[10%]'>
            ...
            <div className=' flex flex-row items-center justify-center lg:gap-4 2xl:gap-7 w-full  my-[6%] relative'>
                <div className=' relative rounded-[30px] overflow-hidden w-[30%] h-[60%] group cursor-pointer'>
                    ...
                    <div className='absolute bottom-0 text-white p-3 my-[4%] hidden group-hover:block'>
                ...
                <div className=' relative rounded-[30px] overflow-hidden w-[30%] h-[60%] group cursor-pointer'>
                    <Image src={TeamPersonTwo} alt="" className='w-[100%]' />
