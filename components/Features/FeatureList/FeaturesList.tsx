...
import {
    ...
    WhatsappIcon,
    XIcon,
} from "@/components/ReusableComponents/IconList";
import DiamondIcon from "@/assets/Features/Diamand.svg";
import SIIcon from "@/assets/Features/sicon-2.png";
import Image from "next/image";

const FeaturesList = () => {
    return (
        <div>
            <div className="relative text-[40px] text-center text-white">
                <p>Sync Node</p>
                <p>The building blocks</p>
                <p className=" bg-gradient-to-b from-[#d1d1d1] to-[#414141] bg-clip-text text-transparent">
                    to democratize comms <br /> on Cardano using
                </p>
            </div>

            <div className=" flex flex-row items-center gap-20 w-full lg:p-10 2xl:p-[100px]">
                {/** Left Feature Boxes */}
                <div className="w-[35%] flex flex-col lg:gap-20 2xl:gap-[160px] relative">

                        <div className="ml-[55%]">
                            {/**SYNC ID */}
                        <FeatureLayer {...anchorIdentityLayer} />
                        </div>

                    <div className="ml-[55%]">
                        <FeatureLayer {...ingressionLayer} />
                    </div>
                </div>
                ...
                {/** SVG */}
                <div className=" absolute w-[100%] h-[100%] ml-[3%] 2xl:ml-[13%] 2xl:w-[75%]  2xl:mt-[-5%] flex items-center">
                    <svg
                        version="1.1"
                ...
                {/** Right Feature Boxes */}
                <div className="w-[20%] flex flex-col lg:gap-0  2xl:gap-16">
                    <FeatureLayer {...dispatchLayer} />
                    <FeatureLayer {...queryingLayer} />
                </div>
            </div>
        </div>
    );
